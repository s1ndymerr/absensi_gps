...
<div style="max-width: 900px; margin: 0 auto; font-family: 'Inter', sans-serif;">
    ...
    <!-- Header Section dengan Efek Glassmorphism (Sama dengan Tambah) -->
    <div style="
    ...
    ">
        ...
        <div style="z-index: 1;">
            <div style="font-size: 0.85rem; font-weight: 700; letter-spacing: 1px; opacity: 0.9; margin-bottom: 8px; text-transform: uppercase;">
                <i class="fas fa-user-shield"></i> Manajemen Guru
            </div>
            <h1 style="margin: 0 0 5px 0; font-size: 1.8rem; font-weight: 800;">Edit Data Guru</h1>
    ...
    <!-- Main Form Card (Layout sama persis dengan Tambah) -->
    <form action="{{ route('admin.guru.update', $guru->id) }}" method="POST" id="teacherForm" style="
        background: white; 
        border-radius: 16px; 
    ...
    ">
        ...
        <!-- Section 1: Data Diri (Urutan Sama dengan Tambah) -->
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 24px;">
                ...
                <div>
                    ...
                    <div style="position: relative;">
                        <input type="text" name="name" class="modern-input {{ $errors->has('name') ? 'input-error' : '' }}" placeholder="Masukkan Nama Lengkap" value="{{ old('name', $guru->nama) }}" required>
                ...
                <div>
                    ...
                    <div style="position: relative;">
                        <input type="text" name="nip" class="modern-input {{ $errors->has('nip') ? 'input-error' : '' }}" placeholder="Nomor Induk Pegawai" value="{{ old('nip', $guru->nip ?? '') }}">
                ...
                <div>
                    ...
                    <div style="position: relative;">
                        <input type="email" name="email" class="modern-input {{ $errors->has('email') ? 'input-error' : '' }}" placeholder="guru@sekolah.id" value="{{ old('email', $guru->email) }}" required>
                ...
                <div>
                    ...
                    <div style="position: relative;">
                        <input type="tel" name="telepon" class="modern-input {{ $errors->has('telepon') ? 'input-error' : '' }}" placeholder="08...." value="{{ old('telepon', $guru->telepon ?? '') }}">
        ...
        <div style="padding: 30px; border-bottom: 1px solid #f8fafc;">
            ...
            <div style="display: grid; gap: 24px;">
                <!-- Password -->
                <div>
                    <label style="display: block; font-size: 0.85rem; font-weight: 600; color: #334155; margin-bottom: 8px;">Password</label>
                    <!-- LOGIKA EDIT: Tidak required, placeholder disesuaikan -->
                    <div style="position: relative;">
                        <input type="password" name="password" id="password" class="modern-input {{ $errors->has('password') ? 'input-error' : '' }}" placeholder="Kosongkan jika tidak ingin mengubah">
                ...
                <div id="passwordConfirmationGroup" style="display: none;">
                    ...
                    <div style="position: relative;">
                        <input type="password" name="password_confirmation" id="password_confirmation" class="modern-input {{ $errors->has('password_confirmation') ? 'input-error' : '' }}" placeholder="Ulangi password">
                        <i class="fas fa-lock input-icon"></i>
        ...
        <!-- Section 3: Tambahan (Sama posisi dengan Tambah) -->
        <div style="padding: 30px; border-bottom: 1px solid #f8fafc;">
            <div style="margin-bottom: 25px; display: flex; align-items: center; gap: 12px;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 24px;">
                ...
                <div>
                    ...
                    <div style="position: relative;">
                        <input type="date" name="tanggal_lahir" class="modern-input" value="{{ old('tanggal_lahir', $guru->tanggal_lahir ?? '') }}" style="color-scheme: light;">
                ...
                <div>
                    ...
                    <div style="position: relative;">
                        <input type="text" name="kelas" class="modern-input {{ $errors->has('kelas') ? 'input-error' : '' }}" placeholder="Contoh: X RPL" value="{{ old('kelas', $guru->kelas) }}">
                ...
                <div>
                    ...
                    <div style="position: relative;">
                        <input type="text" name="jurusan" class="modern-input {{ $errors->has('jurusan') ? 'input-error' : '' }}" placeholder="Contoh: RPL" value="{{ old('jurusan', $guru->jurusan) }}">
                ...
                <div style="grid-column: 1 / -1;">
                    ...
                    <div style="position: relative;">
                        <textarea name="alamat" class="modern-input" rows="3" placeholder="Tulis alamat domisili guru..." style="resize: vertical;">{{ old('alamat', $guru->alamat ?? '') }}</textarea>
        ...
        <!-- Section 4: Status - PERBAIKAN DI SINI -->
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <select name="status_akun" class="modern-input {{ $errors->has('status_akun') ? 'input-error' : '' }}">
                            <option value="aktif" {{ old('status_akun', $guru->status_akun) == 'aktif' ? 'selected' : '' }}">Aktif</option>
                            <option value="tidak_aktif" {{ old('status_akun', $guru->status_akun) == 'tidak_aktif' ? 'selected' : '' }}">Tidak Aktif</option>
                        </select>
...
<style>
    ...
    /* --- Custom Radio Buttons (Style dari Tambah) --- */
    .custom-radio {
        cursor: pointer;
        display: inline-flex;
        align-items: center;
...
<script>
    ...
    function confirmCreate() {
        return confirm('Apakah Anda yakin ingin menyimpan perubahan data guru ini?');
    }
